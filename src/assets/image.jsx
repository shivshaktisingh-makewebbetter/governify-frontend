...
export function ReportIcon() {
  return (
    ...
    >
      <path
        d="M4.80586 1.2531C5.08398 0.943728 5.05898 0.471853 4.74961 0.193728C4.44023 -0.0843965 3.96836 -0.0593966 3.69023 0.249978L1.97148 2.15935L1.28086 1.46873C0.987109 1.1781 0.512109 1.1781 0.218359 1.46873C-0.0753906 1.75935 -0.0753906 2.23748 0.218359 2.5281L1.46836 3.7781C1.61523 3.92498 1.81211 4.0031 2.01836 3.99685C2.22461 3.9906 2.41836 3.9031 2.55586 3.74998L4.80586 1.24998V1.2531ZM4.80586 6.2531C5.08398 5.94373 5.05898 5.47185 4.74961 5.19373C4.44023 4.9156 3.96836 4.9406 3.69023 5.24998L1.97148 7.15935L1.28086 6.46873C0.987109 6.17498 0.512109 6.17498 0.221484 6.46873C-0.0691406 6.76248 -0.0722656 7.23748 0.221484 7.5281L1.47148 8.7781C1.61836 8.92498 1.81523 9.0031 2.02148 8.99685C2.22773 8.9906 2.42148 8.9031 2.55898 8.74998L4.80898 6.24998L4.80586 6.2531ZM6.74961 2.74998H15.2496C15.6652 2.74998 15.9996 2.4156 15.9996 1.99998C15.9996 1.58435 15.6652 1.24998 15.2496 1.24998H6.74961C6.33398 1.24998 5.99961 1.58435 5.99961 1.99998C5.99961 2.4156 6.33398 2.74998 6.74961 2.74998ZM5.99961 6.99998C5.99961 7.4156 6.33398 7.74998 6.74961 7.74998H15.2496C15.6652 7.74998 15.9996 7.4156 15.9996 6.99998C15.9996 6.58435 15.6652 6.24998 15.2496 6.24998H6.74961C6.33398 6.24998 5.99961 6.58435 5.99961 6.99998ZM4.99961 12C4.99961 12.4156 5.33398 12.75 5.74961 12.75H15.2496C15.6652 12.75 15.9996 12.4156 15.9996 12C15.9996 11.5844 15.6652 11.25 15.2496 11.25H5.74961C5.33398 11.25 4.99961 11.5844 4.99961 12ZM2.99961 12C2.99961 11.7348 2.89425 11.4804 2.70672 11.2929C2.51918 11.1053 2.26483 11 1.99961 11C1.73439 11 1.48004 11.1053 1.2925 11.2929C1.10497 11.4804 0.999609 11.7348 0.999609 12C0.999609 12.2652 1.10497 12.5195 1.2925 12.7071C1.48004 12.8946 1.73439 13 1.99961 13C2.26483 13 2.51918 12.8946 2.70672 12.7071C2.89425 12.5195 2.99961 12.2652 2.99961 12Z"
        fill="#5ac063"
      />
    </svg>
  );
...
export function ServiceReportIcon({ activeReport }) {
  return (
    <svg
      width="20"
      height="20"
    ...
    >
      <path
        d="M10 7C9.20435 7 8.44129 7.31607 7.87868 7.87868C7.31607 8.44129 7 9.20435 7 10C7 10.7956 7.31607 11.5587 7.87868 12.1213C8.44129 12.6839 9.20435 13 10 13C10.7956 13 11.5587 12.6839 12.1213 12.1213C12.6839 11.5587 13 10.7956 13 10C13 9.20435 12.6839 8.44129 12.1213 7.87868C11.5587 7.31607 10.7956 7 10 7ZM11.5 10C11.5 10.3978 11.342 10.7794 11.0607 11.0607C10.7794 11.342 10.3978 11.5 10 11.5C9.60218 11.5 9.22064 11.342 8.93934 11.0607C8.65804 10.7794 8.5 10.3978 8.5 10C8.5 9.60218 8.65804 9.22064 8.93934 8.93934C9.22064 8.65804 9.60218 8.5 10 8.5C10.3978 8.5 10.7794 8.65804 11.0607 8.93934C11.342 9.22064 11.5 9.60218 11.5 10ZM9.34062 2C8.64687 2 8.04375 2.475 7.88125 3.14688L7.625 4.21875L7.59062 4.23125L6.65312 3.65625C6.0625 3.29375 5.3 3.38437 4.80938 3.875L3.87812 4.80938C3.3875 5.3 3.29688 6.0625 3.65937 6.65312L4.23438 7.59062L4.21875 7.625L3.15 7.88438C2.475 8.04375 2 8.64687 2 9.34062V10.6594C2 11.3531 2.475 11.9562 3.14688 12.1187L4.21875 12.375L4.23125 12.4094L3.65625 13.3469C3.29375 13.9375 3.38437 14.7 3.875 15.1906L4.80625 16.1219C5.29688 16.6125 6.05938 16.7031 6.65 16.3406L7.5875 15.7656L7.62187 15.7781L7.88125 16.8469C8.04375 17.5219 8.64687 17.9937 9.34062 17.9937H10.6594C11.3531 17.9937 11.9562 17.5188 12.1187 16.8469L12.375 15.7812L12.4094 15.7688L13.3469 16.3438C13.9375 16.7063 14.7 16.6156 15.1906 16.125L16.1219 15.1938C16.6125 14.7031 16.7031 13.9406 16.3406 13.35L15.7656 12.4125L15.7781 12.3781L16.8469 12.1187C17.5219 11.9562 17.9937 11.3531 17.9937 10.6594V9.34062C17.9937 8.64687 17.5188 8.04375 16.8469 7.88125L15.7812 7.625L15.7688 7.59062L16.3438 6.65312C16.7063 6.0625 16.6156 5.3 16.125 4.80938L15.1906 3.87812C14.7 3.3875 13.9375 3.29688 13.3469 3.65937L12.4094 4.23438L12.375 4.21875L12.1156 3.15C11.9563 2.475 11.3531 2 10.6594 2H9.34062ZM9.34062 3.5H10.6594L11.0125 4.95625C11.0719 5.20625 11.2594 5.40937 11.5031 5.49062C11.7156 5.5625 11.925 5.64688 12.125 5.74688C12.3562 5.8625 12.6312 5.85 12.8531 5.71563L14.1313 4.93438L15.0625 5.86875L14.2812 7.14687C14.1469 7.36875 14.1344 7.64375 14.25 7.875C14.35 8.075 14.4375 8.28125 14.5063 8.49687C14.5875 8.74375 14.7906 8.92813 15.0406 8.9875L16.5 9.34062V10.6594L15.0437 11.0125C14.7937 11.0719 14.5906 11.2594 14.5094 11.5031C14.4375 11.7156 14.3531 11.925 14.2531 12.125C14.1375 12.3562 14.15 12.6312 14.2844 12.8531L15.0656 14.1313L14.1313 15.0625L12.8531 14.2812C12.6312 14.1469 12.3562 14.1344 12.125 14.25C11.925 14.35 11.7188 14.4375 11.5031 14.5063C11.2563 14.5875 11.0719 14.7906 11.0125 15.0406L10.6594 16.5H9.34062L8.9875 15.0437C8.92813 14.7937 8.74062 14.5906 8.49687 14.5094C8.28437 14.4375 8.075 14.3531 7.875 14.2531C7.64375 14.1375 7.36875 14.15 7.14687 14.2844L5.86875 15.0656L4.9375 14.1313L5.71875 12.8531C5.85313 12.6312 5.86562 12.3562 5.75 12.125C5.65 11.925 5.5625 11.7188 5.49375 11.5031C5.4125 11.2563 5.20937 11.0719 4.95937 11.0125L3.5 10.6594V9.34062L4.95625 8.9875C5.20625 8.92813 5.40937 8.74062 5.49062 8.49687C5.5625 8.28437 5.64688 8.075 5.74688 7.875C5.8625 7.64375 5.85 7.36875 5.71563 7.14687L4.9375 5.86875L5.86875 4.9375L7.14687 5.71875C7.36875 5.85313 7.64375 5.86562 7.875 5.75C8.075 5.65 8.28125 5.5625 8.49687 5.49375C8.74375 5.4125 8.92813 5.20937 8.9875 4.95937L9.34062 3.5Z"
        fill={activeReport === "service" ? "white" : "#202223"}
      />
    </svg>
  );
}

export function ComplianceReportIcon({ activeReport }) {
  return (
    <svg
      width="20"
      height="20"
...
export function ComplianceReportIconEmpty() {
  return (
    <svg
      width="60"
      height="60"
...
export function ListReportIcon({ activeReport, activeView }) {
  return (
    <svg
      width="20"
      height="20"
    ...
    >
      <path
        d="M4 4C3.73478 4 3.48043 4.10536 3.29289 4.29289C3.10536 4.48043 3 4.73478 3 5C3 5.26522 3.10536 5.51957 3.29289 5.70711C3.48043 5.89464 3.73478 6 4 6C4.26522 6 4.51957 5.89464 4.70711 5.70711C4.89464 5.51957 5 5.26522 5 5C5 4.73478 4.89464 4.48043 4.70711 4.29289C4.51957 4.10536 4.26522 4 4 4ZM7.75 4.25C7.33437 4.25 7 4.58438 7 5C7 5.41562 7.33437 5.75 7.75 5.75H17.25C17.6656 5.75 18 5.41562 18 5C18 4.58438 17.6656 4.25 17.25 4.25H7.75ZM7.75 9.25C7.33437 9.25 7 9.58437 7 10C7 10.4156 7.33437 10.75 7.75 10.75H17.25C17.6656 10.75 18 10.4156 18 10C18 9.58437 17.6656 9.25 17.25 9.25H7.75ZM7.75 14.25C7.33437 14.25 7 14.5844 7 15C7 15.4156 7.33437 15.75 7.75 15.75H17.25C17.6656 15.75 18 15.4156 18 15C18 14.5844 17.6656 14.25 17.25 14.25H7.75ZM5 10C5 9.73478 4.89464 9.48043 4.70711 9.29289C4.51957 9.10536 4.26522 9 4 9C3.73478 9 3.48043 9.10536 3.29289 9.29289C3.10536 9.48043 3 9.73478 3 10C3 10.2652 3.10536 10.5196 3.29289 10.7071C3.48043 10.8946 3.73478 11 4 11C4.26522 11 4.51957 10.8946 4.70711 10.7071C4.89464 10.5196 5 10.2652 5 10ZM4 14C3.73478 14 3.48043 14.1054 3.29289 14.2929C3.10536 14.4804 3 14.7348 3 15C3 15.2652 3.10536 15.5196 3.29289 15.7071C3.48043 15.8946 3.73478 16 4 16C4.26522 16 4.51957 15.8946 4.70711 15.7071C4.89464 15.5196 5 15.2652 5 15C5 14.7348 4.89464 14.4804 4.70711 14.2929C4.51957 14.1054 4.26522 14 4 14Z"
        fill={
          activeReport === "compliance" && activeView === "list"
            ? "#5ac063"
            : "#202223"
        }
      />
...
export function ChartViewIcon({ activeReport, activeView }) {
  return (
    <svg
      width="20"
      height="20"
    ...
    >
      <path
        d="M2.75 3C3.16562 3 3.5 3.33437 3.5 3.75V14.75C3.5 15.1656 3.83438 15.5 4.25 15.5H17.25C17.6656 15.5 18 15.8344 18 16.25C18 16.6656 17.6656 17 17.25 17H4.25C3.00625 17 2 15.9937 2 14.75V3.75C2 3.33437 2.33437 3 2.75 3ZM7.25 9C7.66563 9 8 9.33437 8 9.75V12.25C8 12.6656 7.66563 13 7.25 13C6.83437 13 6.5 12.6656 6.5 12.25V9.75C6.5 9.33437 6.83437 9 7.25 9ZM11 6.75V9.25C11 9.66563 10.6656 10 10.25 10C9.83437 10 9.5 9.66563 9.5 9.25V6.75C9.5 6.33437 9.83437 6 10.25 6C10.6656 6 11 6.33437 11 6.75ZM13.25 4C13.6656 4 14 4.33438 14 4.75V7.25C14 7.66563 13.6656 8 13.25 8C12.8344 8 12.5 7.66563 12.5 7.25V4.75C12.5 4.33438 12.8344 4 13.25 4ZM17 4.75V12.25C17 12.6656 16.6656 13 16.25 13C15.8344 13 15.5 12.6656 15.5 12.25V4.75C15.5 4.33438 15.8344 4 16.25 4C16.6656 4 17 4.33438 17 4.75Z"
        fill={
          activeReport === "compliance" && activeView === "chart"
            ? "#5ac063"
            : "#202223"
        }
      />
...
export function ExportReportViewIcon() {
  return (
    <svg
      width="16"
      height="16"
