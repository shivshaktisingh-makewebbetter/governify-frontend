...
export const SortingAndFilterComponent = () =>{
    return (
        <div style={{display:'flex' , justifyContent:'left' , paddingTop:'8px' , marginBottom:'32px'}}>
            <Button style={{display:'flex' , alignItems:'center' , gap:'5px'}} type='text' className="governify-sortby-button"> <span><i class="bi bi-sort-down"></i></span><span className='fs-16 text-color-928f8f'>Sort By</span> </Button>
