	...
	return (
		...
		>
			<div className="step-count fs-1 " >
				<span className="fw-bolder ff-ws " style={{ fontSize: "70px",color:link_btn_bg }}>
          {
            (step<10)?'0'+step:step
          }
				</span>
			...
			<div className="m-0 p-0 d-flex flex-column align-items-start justify-content-center">
				<p className="fs-4 fw-bolder m-0 p-0 my-1">Preparing and submitting documents</p>
				<p className={`status fw-bold  ${step%2?'text-warning':'text-success'} m-0 p-0`}>{step%2?'In Progress':'Completed'}</p>
			</div>
