            ...
            return (
                <div className='governify-option-list-repetitive'>
                   ...
                   <div style={{display:'flex' , alignItems:'center' , justifyContent:'center'}}>
                    <Button type='primary' className='border-radius-10 fs-17 fw-600 h-40' style={{background:settingData.button_bg , color:'#fff' , display:'flex'  ,gap:'10px', alignItems:'center'}} onClick={()=>handleAdminRoute(item.title)}><span>{item.buttonText}</span><span className='fs-16'><i class="bi bi-arrow-right-circle-fill"></i></span></Button>
                   </div>
