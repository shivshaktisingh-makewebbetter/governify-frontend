  ...
  const {link_btn_bg , link_btn_color ,link_headtitle } = settings;
    ...
    return (
      ...
      <div class="form_wrapper border border-success p-4 primary-shadow" style={{overflowY:'auto'}}>
            ...
            <div className="mt-16" style={{display:'flex' , justifyContent:"center"}}><Button style={{background:link_btn_bg , color:link_btn_color , border:"none"}} className='fw-700' onClick={handleEditCategory} loading={loading}>Update</Button></div>
        </div>
        </div>
        </div>
