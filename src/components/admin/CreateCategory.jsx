...
export const CreateCategory = ({setShowSkeleton , setLoading , loading , setModalOpen}) =>{
  ...
  const data = JSON.parse(sessionStorage.getItem('settings'));
    ...
    return (
      ...
      <div>
      <div className="text-white" style={{ backgroundColor: data.head_title_color }}>
          <p className="p-2 m-0 fs-5" style={{display:"flex" , justifyContent:"space-between"}}><strong>Create Category</strong><span style={{display:"flex" , alignItems:"center" ,}}><a className="fs_14" style={{textDecoration:"none"}} target="_blank" rel="noreferrer" href="https://icons.getbootstrap.com/">Go to Icon's library </a></span></p>
      </div>
