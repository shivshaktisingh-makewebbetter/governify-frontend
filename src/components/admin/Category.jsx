    ...
    <div className="mt-100">
      ...
      >
        <Button
          icon={
            <LeftOutlined
              style={{ color: data.button_bg, borderColor: data.button_bg }}
            />
          }
          onClick={handleBackNavigation}
        ></Button>
        <Button
          style={{ borderColor: data.button_bg, color: data.button_bg }}
        ...
        <thead>
          <tr style={styles.headerParent}>
            ...
            <th style={styles.header}>
              <span style={styles.spanPadding}>|</span>Title
            </th>
            <th style={styles.description}>
